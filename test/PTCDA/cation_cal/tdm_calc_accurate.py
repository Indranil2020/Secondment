...
# Closed-shell (spin=1): Uses RKS/TDDFT
# Open-shell (spin>1): Uses UKS/TDDFT
...
print(f"TDDFT method: {'TDDFT (RKS-based)' if actual_spin == 1 else 'TDDFT (UKS-based)'}")
...
if not td.converged:
    print("WARNING: TDDFT did not converge for some states!")
else:
